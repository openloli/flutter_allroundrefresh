...
class _Sample5State extends State<Sample5> with TickerProviderStateMixin {
...
//                refresher.sendStatus(RefreshStatus.completed);
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 10000)).then((val) {
      _fetch(true);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('5自定义始化转圈1(10秒)'),
      ),
